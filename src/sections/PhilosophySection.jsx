...
export function PhilosophySection() {
  ...
  return (
    <section id="philosophy" ref={ref} className="py-32 md:py-48 bg-[#0A0A0A] selection:bg-accent-red selection:text-white relative font-sans overflow-hidden">
      <div className="max-w-7xl mx-auto px-8 lg:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-start">
          ...
          >
            <motion.div custom={0} variants={fadeUpVariants} className="flex items-center gap-4">
            ...
            <motion.p 
              custom={2}
              variants={fadeUpVariants}
              className="font-light text-white/60 leading-relaxed text-xl max-w-xl"
            >
              I believe that the most powerful systems are those where technical precision meets human intuition. 
              At Archphaze, my mission is to build digital environments that are structural, intentional, and enduring.
            </motion.p>
          ...
          >
            {PHILOSOPHY_TRUTHS.map((truth, index) => (
              ...
              >
                <span className="text-accent-red font-serif text-6xl leading-none opacity-40 group-hover:opacity-100 transition-all duration-500">“</span>
                <p className="font-light italic text-white/70 group-hover:text-white transition-colors duration-500 text-xl leading-relaxed -mt-8">
                  {truth}
                </p>
              </motion.div>
            ))}
          ...
          >
            ...
            >
              ...
              <div className="md:col-span-4 bg-white p-10 md:p-16 flex flex-col justify-center relative overflow-hidden group">
                <span className="text-accent-red font-bold tracking-[0.4em] text-[10px] uppercase mb-8 block">THE FOUNDER'S JOURNEY</span>
                <h2 className="text-4xl md:text-7xl font-serif text-black leading-[1.1] mb-8">
                  Architecting <span className="italic text-accent-red">Momentum.</span>
                </h2>
              ...
              <div className="md:col-span-1 bg-accent-red p-10 flex flex-col justify-between aspect-square md:aspect-auto">
                 <span className="font-mono text-[10px] uppercase tracking-widest text-white/60">01 // Expertise</span>
                 <h3 className="text-2xl font-serif text-white leading-tight">{STORY_CONTENT.tech}</h3>
              </div>

              {/* CARD 3: LEGACY (Dark Contrast) */}
              <div className="md:col-span-2 bg-[#111] border border-white/10 p-10 flex flex-col justify-between">
                 <span className="text-accent-red font-bold text-[10px] tracking-widest uppercase">02 // Legacy</span>
              ...
              <div className="md:col-span-3 bg-white/5 border border-white/10 p-10 flex flex-col md:flex-row md:items-center justify-between gap-8">
                 <div className="max-w-xl">
                   <span className="text-accent-red font-bold text-[10px] tracking-widest uppercase mb-4 block">03 // Philosophy</span>
                   <p className="text-xl text-white/80 font-light leading-relaxed">{STORY_CONTENT.values}</p>
                 </div>
              </div>
